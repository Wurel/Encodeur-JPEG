...
// }
//
// void jpeg_desc_write_header(struct jpeg_desc *jdesc){
...
//     bitstream_write_nbits(jdesc->bits, jpeg_desc_get_image_height(jdesc), 16, 0);
//     bitstream_write_nbits(jdesc->bits, jpeg_desc_get_image_width(jdesc), 16, 0);
