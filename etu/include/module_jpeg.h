...
/* Ecrit le nom du fichier de sortie jpeg_filename dans le jpeg_desc jdesc. */
extern void jpeg_desc_set_jpeg_filename(struct jpeg_desc *jdesc, const char *jpeg_filename);
...
/*
    ...
    le jpeg_desc jdesc.
*/
extern void jpeg_desc_set_image_height(struct jpeg_desc *jdesc, uint32_t image_height);
/*
...
/*
    ...
    jpeg_desc jdesc.
*/
extern void jpeg_desc_set_image_width(struct jpeg_desc *jdesc, uint32_t image_width);
...
*/
extern void jpeg_desc_set_nb_components(struct jpeg_desc *jdesc, uint8_t nb_components);
...
*/
extern struct huff_table *jpeg_desc_get_huffman_table(struct jpeg_desc *jdesc, enum sample_type acdc, enum color_component cc);
...
*/
extern void jpeg_desc_set_quantization_table(struct jpeg_desc *jdesc, enum color_component cc, uint8_t *qtable);
